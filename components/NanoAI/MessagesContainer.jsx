...
const MessagesContainer = ({
  ...
  return (
    <div className="NanoAI-flex-scroll h-full ">
      <div 
        ref={messagesContainerRef}
        className={`NanoAI-chat-container NanoAI-scrollbar NanoAI-prevent-overscroll flex-1 ${isDark ? 'bg-gray-950' : 'bg-gray-50'} relative`}
        style={{ 
          height: '100%',
          maxHeight: '100%',
          overflowY: 'auto',
      ...
      >
        ...
        <div className="pb-32 sm:pb-40 NanoAI-message-wrapper ">
