...
export default function QuizPage() {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion < quiz.questions.length - 1) {
      ...
      // Get the answer for the next question from the updated array
      const nextAnswer = newAnswers[nextQuestionIndex] || "";
  ...
  const handlePrevious = () => {
    if (currentQuestion > 0) {
      ...
      const prevAnswer = userAnswers[prevQuestionIndex] || "";
  ...
  const submitQuiz = async (answers) => {
    ...
    try {
      ...
      for (let index = 0; index < quiz.questions.length; index++) {
        ...
        setSubmitStage(
          `Analyzing question ${index + 1} of ${quiz.questions.length}...`
        );
      ...
      <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-black pt-16 sm:pt-20">
        <div className="flex-grow flex items-center justify-center p-2 sm:p-4">
          <div className="w-full max-w-full sm:max-w-2xl mx-auto">
            <div
              className="bg-white dark:bg-black rounded-lg shadow-lg p-4 sm:p-8 text-center border border-gray-200 dark:border-gray-800"
              ...
              <div className="p-4 sm:p-6 dark:bg-black">
                ...
                >
                  <QuestionDisplay
                    ...
                    onAnswerSelect={
                      isFullscreen ? handleAnswerSelect : () => {}
                    }
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div
                    className={`flex gap-2 order-2 sm:order-1 transition-all duration-300 ${
                      !isFullscreen
                  ...
                  >
                    <button
                      ...
                      disabled={
                        currentQuestion === 0 || submitting || !isFullscreen
                      }
