...
export default function NanoAIHome() {
  ...
  const quickStartOptions = [
    {
      ...
      icon: Brain,
      prompt: 'Hi NanoAI! I need help understanding a concept. Can you help me break down complex topics into simpler, easier-to-understand explanations?',
    ...
    },
    {
      ...
      icon: BookOpen,
      prompt: 'Hi NanoAI! I need help with my homework. Can you guide me through solving problems step by step?',
