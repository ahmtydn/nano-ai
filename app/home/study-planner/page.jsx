      ...
      <div className={`min-h-screen relative overflow-hidden pt-16 transition-colors duration-300 ${isDark ? 'bg-black' : 'bg-gradient-to-br from-blue-50 via-white to-purple-50'} ${isDark ? 'dark' : ''}`}>
        ...
        {showNotifications && (
          <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
            <div className="bg-green-500 text-white px-6 py-3 rounded-lg flex items-center space-x-2">
              ...
              <div className="flex flex-wrap justify-center gap-1 md:gap-2 rounded-xl p-1">
                <button
                  ...
                  className={`group relative px-3 py-2 md:px-4 md:py-2 rounded-lg font-medium text-sm transition-all duration-300 flex items-center space-x-2 ${
                    activeTab === "create"
                      ? isDark 
                        ? "bg-gradient-to-r from-indigo-600/60 to-purple-600/60 backdrop-blur-md border border-indigo-400/30 transform scale-105 text-white" 
                        : "bg-gradient-to-r from-indigo-500/80 to-purple-600/80 backdrop-blur-md border border-white/30 transform scale-105 text-white"
                      : isDark
          ...
          <div className="space-y-6">
            ...
            {activeTab === "roadmap" && (
              <div className="space-y-6 animate-slide-in-up">
                {selectedPlannerData ? (
                  <>
                    <div className="bg-white/80 dark:bg-black/80 rounded-xl p-6 border border-gray-200/60 dark:border-gray-700/60 backdrop-blur-sm">
                    ...
                    <div className="bg-white/80 dark:bg-black/80 rounded-xl p-4 md:p-6 border border-gray-200/60 dark:border-gray-700/60 backdrop-blur-sm">
                                  ...
                                  {row.map((note, colIndex) => {
                                    ...
                                    return (
                                      <div key={note._id} className="relative">
                                        ...
                                        >
                                          <div
                                            className={`relative p-3 md:p-4 rounded-lg border-2 transition-all duration-300 ${
                                              note.is_completed
                  ...
                  <div className="bg-white/80 dark:bg-black/80 rounded-xl p-6 border border-gray-200/60 dark:border-gray-700/60 backdrop-blur-sm text-center">
