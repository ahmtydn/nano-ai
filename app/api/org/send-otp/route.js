...
export async function POST(request) {
  try {
    ...
    if (!org_mail.endsWith("edu.tr")) {
      return NextResponse.json(
        { success: false, message: "Only edu.tr emails are accepted" },
        { status: 400 }
      );
    }
    ...
    const mailOptions = {
      ...
      to: org_mail,
      subject: "Nano AI – Knowledge Nest Organization Verification",
      html: `
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden;">
            ...
            <tr>
              <td style="background:#1a73e8; padding:20px; text-align:center; color:#ffffff;">
                <h1 style="margin:0; font-size:24px;">Nano AI</h1>
            ...
            <tr>
              <td style="background:#fafafa; padding:20px; border-top:1px solid #e2e2e2;">
                ...
                <p style="font-size:12px; color:#888888; margin:5px 0 0;">
                  If you didn’t request this, please ignore. Only edu.tr emails are accepted.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="background:#f4f4f4; padding:15px; text-align:center;">
                <p style="font-size:12px; color:#aaaaaa; margin:0;">
                  © ${new Date().getFullYear()} Nano AI. Empowering collaborative learning.
                </p>
              </td>
            </tr>
    ...
    return NextResponse.json(
      {
        success: false,
        message: "Failed to send organization verification OTP",
      },
      { status: 500 }
    );
  }
